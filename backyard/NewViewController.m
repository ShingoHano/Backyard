...
@synthesize item,purchaseView,infoLabel,options;
...
-(void)deleteAnimation1
{
    ...
    [UIView animateWithDuration: IMG_ONOFF_INTERVAL
                     ...
                     completion: ^(BOOL finished){can1.alpha = 0.0;[can1 removeFromSuperview];
                         //                         [self deleteSound];
                         //                         AudioServicesPlaySystemSound(ssidDeleteSound);
                         [self deleteImage1];
                         if(Image1Count>=1)
                         {
                             sleep(0.2);
...
/*- (void)deleteSound
 {
 // 効果音
 NSString* path = [[NSBundle mainBundle] pathForResource:@"waterdrop1" ofType:@"wav"];
 NSURL* url = [NSURL fileURLWithPath:path];
 SystemSoundID ssidOpenMouth;
 AudioServicesCreateSystemSoundID((__bridge CFURLRef)url, &ssidOpenMouth);
 
 // 再生
 AudioServicesPlaySystemSound(ssidOpenMouth);
...
/*- (void)touchSound
 {
 // 効果音
 NSString* path = [[NSBundle mainBundle] pathForResource:@"decide15" ofType:@"wav"];
 NSURL* url = [NSURL fileURLWithPath:path];
 SystemSoundID ssidOpenMouth;
 AudioServicesCreateSystemSoundID((__bridge CFURLRef)url, &ssidOpenMouth);
...
- (IBAction) displayMenu:(id)sender{
    ...
    else
    {
        ...
        /*
         ...
         // 効果音
         NSString* path = [[NSBundle mainBundle] pathForResource:@"warp3" ofType:@"wav"];
         NSURL* url = [NSURL fileURLWithPath:path];
         SystemSoundID ssidOpenMouth;
         AudioServicesCreateSystemSoundID((__bridge CFURLRef)url, &ssidOpenMouth);
         ...
         //解放
         AudioServicesDisposeSystemSoundID(ssidOpenMouth);
         */
...
- (void)levelUp
{
    ...
    {
        /*        // 効果音
         NSString* path = [[NSBundle mainBundle] pathForResource:@"status5" ofType:@"wav"];
         NSURL* url = [NSURL fileURLWithPath:path];
         SystemSoundID ssidOpenMouth;
         AudioServicesCreateSystemSoundID((__bridge CFURLRef)url, &ssidOpenMouth);*/
        
        // 再生
        //        AudioServicesPlaySystemSound(ssidLevelSound);
...
{
    /*
     [mainPlayer stop];      //画面BGMの停止
     [player play];          //ゲームBGMの再生
     */
...
-(void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event{
    ...
    if ( distanceHorizontal < distanceVertical && tEnded.y < tBegan.y)
    {
        if(tBegan.x>74 && tBegan.x<130)
        {
            ...
            {
                //                [self touchImage1];
                //                [self performSelectorInBackground:@selector(touchImage1) withObject:nil];
                //                [self performSelectorInBackground:@selector(touchAnimation1) withObject:nil];
                [self touchAnimation1];
            }
            else if(PatternType==1)
            {
                //                [self touchImage2];
                //                [self performSelectorInBackground:@selector(touchImage2) withObject:nil];
                //                [self performSelectorInBackground:@selector(touchAnimation4) withObject:nil];
                [self touchAnimation4];
            }
            else if(PatternType==2)
            {
                //                [self touchImage3];
                //                [self performSelectorInBackground:@selector(touchImage3) withObject:nil];
                //                [self performSelectorInBackground:@selector(touchAnimation7) withObject:nil];
                [self touchAnimation7];
            }
            else if(PatternType==3)
            {
                //                [self touchImage4];
                //                [self performSelectorInBackground:@selector(touchImage4) withObject:nil];
                //                [self performSelectorInBackground:@selector(touchAnimation10) withObject:nil];
        ...
        if(tBegan.x >132 && tBegan.x<188)
        {
            if(PatternType==0)
            {
                //                [self touchImage2];
                //                [self performSelectorInBackground:@selector(touchImage2) withObject:nil];
                //                [self performSelectorInBackground:@selector(touchAnimation2) withObject:nil];
            ...
            else if(PatternType==1)
            {
                //                [self touchImage3];
                //                [self performSelectorInBackground:@selector(touchImage3) withObject:nil];
                //                [self performSelectorInBackground:@selector(touchAnimation5) withObject:nil];
            ...
            else if(PatternType==2)
            {
                //                [self touchImage4];
                //                [self performSelectorInBackground:@selector(touchImage4) withObject:nil];
                //                [self performSelectorInBackground:@selector(touchAnimation8) withObject:nil];
                [self touchAnimation8];
            }
            else if(PatternType==3)
            {
                //                [self touchImage5];
                //                [self performSelectorInBackground:@selector(touchImage5) withObject:nil];
                //                [self performSelectorInBackground:@selector(touchAnimation11) withObject:nil];
        ...
        if(tBegan.x >190 && tBegan.x<246)
        {
            if(PatternType==0)
            {
                //                [self touchImage3];
                //                [self performSelectorInBackground:@selector(touchImage3) withObject:nil];
                //                [self performSelectorInBackground:@selector(touchAnimation3) withObject:nil];
            ...
            else if(PatternType==1)
            {
                //                [self touchImage4];
                //                [self performSelectorInBackground:@selector(touchImage4) withObject:nil];
                //                [self performSelectorInBackground:@selector(touchAnimation6) withObject:nil];
            ...
            else if(PatternType==2)
            {
                //                [self touchImage5];
                //                [self performSelectorInBackground:@selector(touchImage5) withObject:nil];
                //                [self performSelectorInBackground:@selector(touchAnimation9) withObject:nil];
                [self touchAnimation9];
            }
            else if(PatternType==3)
            {
                //                [self touchImage6];
                //                [self performSelectorInBackground:@selector(touchImage6) withObject:nil];
                //                [self performSelectorInBackground:@selector(touchAnimation12) withObject:nil];
...
-(void)randomDelete
{
    ...
    switch (temp) {
        case 0:
            [self animation1];
            //            [self performSelectorInBackground:@selector(animation1) withObject:nil];
            break;
        case 1:
            [self animation2];
            //            [self performSelectorInBackground:@selector(animation2) withObject:nil];
            break;
        case 2:
            [self animation3];
            //            [self performSelectorInBackground:@selector(animation3) withObject:nil];
            break;
        case 3:
            [self animation4];
            //            [self performSelectorInBackground:@selector(animation4) withObject:nil];
            break;
        case 4:
            [self animation5];
            //            [self performSelectorInBackground:@selector(animation5) withObject:nil];
            break;
        case 5:
            [self animation6];
            //            [self performSelectorInBackground:@selector(animation6) withObject:nil];
            break;
        default:
            break;
    }
...
-(void)gameOver
{
    /*
     ...
     // 効果音
     NSString* path = [[NSBundle mainBundle] pathForResource:@"status4" ofType:@"wav"];
     NSURL* url = [NSURL fileURLWithPath:path];
     SystemSoundID ssidOpenMouth;
     AudioServicesCreateSystemSoundID((__bridge CFURLRef)url, &ssidOpenMouth);
...
//    [item removeFromSuperview];
    ...
    /*
     //時給、ボス回数、補充回数を記録する
     //前回のスコアを読み出し、保存キーを変更する
     int beforeHourlyWages=[userDefaults integerForKey:@"HIGH_HourlyWages"];
     int beforeBossCount=[userDefaults integerForKey:@"HIGH_BossCount"];
     int beforeTouchCount=[userDefaults integerForKey:@"HIGH_TouchCount"];
     
     //ハイスコアの場合は記録を更新する
     if((HourlyWages>beforeHourlyWages) || (beforeHourlyWages==HourlyWages && BossCount>beforeBossCount)||(beforeHourlyWages==HourlyWages && BossCount==beforeBossCount && TouchCount>beforeTouchCount))
     {
     [userDefaults setInteger:HourlyWages forKey:@"HIGH_HourlyWages"];
     [userDefaults setInteger:BossCount forKey:@"HIGH_BossCount"];
     [userDefaults setInteger:TouchCount forKey:@"HIGH_TouchCount"];
     }
     
     //今回のスコア記録
     [userDefaults setInteger:HourlyWages forKey:@"NEW_HourlyWages"];
     [userDefaults setInteger:BossCount forKey:@"NEW_BossCount"];
     [userDefaults setInteger:TouchCount forKey:@"NEW_TouchCount"];*/
...
-(void)touchAnimation1
{
    ...
    [can1 setFrame:CGRectMake(74, 543, 41, 46)];
    [self.view addSubview:can1];
    ...
    [UIView animateWithDuration:CAN_SPEED
                     ...
                     completion:^(BOOL finished) {
                         ...
                         //                         [self deleteAnimation:1];
                         [UIView animateWithDuration:CAN_SPEED
                                          animations:^{can1.frame =CGRectOffset(can1.frame, 3*temp, -27*temp);}
                                          completion:^(BOOL finished) {
                                              //                                              [self touchSound];
                                              //                                              AudioServicesPlaySystemSound(ssidTouchSound);
                                              [self touchImage1];
...
-(void)touchAnimation2
{
    ...
    [can2 setFrame:CGRectMake(132, 543, 41, 46)];
    [self.view addSubview:can2];
    ...
    [UIView animateWithDuration:CAN_SPEED
                     ...
                     completion:^(BOOL finished) {
                         ...
                         //                         [self deleteAnimation:1];
                         [UIView animateWithDuration:CAN_SPEED
                                          animations:^{can2.frame =CGRectOffset(can2.frame, 2*temp, -27*temp);}
                                          completion:^(BOOL finished) {
                                              //                                              [self touchSound];
                                              //                                              AudioServicesPlaySystemSound(ssidTouchSound);
                                              [self touchImage2];
...
-(void)touchAnimation3
{
    ...
    [can3 setFrame:CGRectMake(190, 543, 41, 46)];
    [self.view addSubview:can3];
    ...
    [UIView animateWithDuration:CAN_SPEED
                     ...
                     completion:^(BOOL finished) {
                         ...
                         //                         [self deleteAnimation:1];
                         [UIView animateWithDuration:CAN_SPEED
                                          animations:^{can3.frame =CGRectOffset(can3.frame, 1*temp, -27*temp);}
                                          completion:^(BOOL finished) {
                                              //                                              [self touchSound];
                                              //         AudioServicesPlaySystemSound(ssidTouchSound);
                                              [self touchImage3];
...
-(void)touchAnimation4
{
    ...
    UIImageView *can2 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"缶_立体_トマトジュース"]];
    [can2 setFrame:CGRectMake(74, 543, 41, 46)];
    [self.view addSubview:can2];
...
-(void)touchAnimation5
{
    ...
    UIImageView *can3 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"缶_立体_コンポタ"]];
    [can3 setFrame:CGRectMake(132, 543, 41, 46)];
    [self.view addSubview:can3];
...
-(void)touchAnimation6
{
    ...
    [can4 setFrame:CGRectMake(190, 543, 41, 46)];
    [self.view addSubview:can4];
    ...
    [UIView animateWithDuration:CAN_SPEED
                     ...
                     completion:^(BOOL finished) {
                         ...
                         //                         [self deleteAnimation:1];
                         [UIView animateWithDuration:CAN_SPEED
                                          animations:^{can4.frame =CGRectOffset(can4.frame, -1*temp, -27*temp);}
                                          completion:^(BOOL finished) {
                                              //                                              [self touchSound];
                                              //            AudioServicesPlaySystemSound(ssidTouchSound);
                                              [self touchImage4];
...
-(void)touchAnimation7
{
    ...
    UIImageView *can3 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"缶_立体_コンポタ"]];
    [can3 setFrame:CGRectMake(74, 543, 41, 46)];
    [self.view addSubview:can3];
...
-(void)touchAnimation8
{
    ...
    UIImageView *can4 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"缶_立体_コーヒー"]];
    [can4 setFrame:CGRectMake(132, 543, 41, 46)];
    [self.view addSubview:can4];
...
-(void)touchAnimation9
{
    ...
    [can5 setFrame:CGRectMake(190, 543, 41, 46)];
    [self.view addSubview:can5];
    ...
    [UIView animateWithDuration:CAN_SPEED
                     ...
                     completion:^(BOOL finished) {
                         ...
                         //                         [self deleteAnimation:1];
                         [UIView animateWithDuration:CAN_SPEED
                                          animations:^{can5.frame =CGRectOffset(can5.frame, -2*temp, -27*temp);}
                                          completion:^(BOOL finished) {
                                              //                                              [self touchSound];
                                              //              AudioServicesPlaySystemSound(ssidTouchSound);
                                              [self touchImage5];
...
-(void)touchAnimation10
{
    ...
    UIImageView *can4 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"缶_立体_コーヒー"]];
    [can4 setFrame:CGRectMake(74, 543, 41, 46)];
    [self.view addSubview:can4];
...
-(void)touchAnimation11
{
    ...
    UIImageView *can5 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"缶_立体_コーヒーブラック"]];
    [can5 setFrame:CGRectMake(132, 543, 41, 46)];
    [self.view addSubview:can5];
...
-(void)touchAnimation12
{
    ...
    [can6 setFrame:CGRectMake(190, 543, 41, 46)];
    [self.view addSubview:can6];
    ...
    [UIView animateWithDuration:CAN_SPEED
                     ...
                     completion:^(BOOL finished) {
                         ...
                         //                         [self deleteAnimation:1];
                         [UIView animateWithDuration:CAN_SPEED
                                          animations:^{can6.frame =CGRectOffset(can6.frame, -3*temp, -27*temp);}
                                          completion:^(BOOL finished) {
                                              //                                              [self touchSound];
                                              //               AudioServicesPlaySystemSound(ssidTouchSound);
                                              [self touchImage6];
