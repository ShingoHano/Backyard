...
iPadScoreViewController *scoreView; //スコア用のビューコントローラー
...
- (void)viewDidLoad
{
    ...
    imageStr[0]=@"缶_正面_みかんジュース.png";
    imageStr[1]=@"缶_正面_トマトジュース.png";
    imageStr[2]=@"缶_正面_コンポタ.png";
    imageStr[3]=@"缶_正面_コーヒー.png";
    imageStr[4]=@"缶_正面_コーヒーブラック.png";
    imageStr[5]=@"缶_正面_葡萄ジュース.png";
...
-(void)bossAnimation
{
    ...
    [boss setFrame:CGRectMake(CUSTOMER_MAKE_X, CUSTOMER_MAKE_Y-5, 90, 90)];
    ...
    [UIView animateWithDuration:2.0
                     ...
                     completion:^(BOOL finished) {
                         ...
                         [UIView animateWithDuration:0.5
                                          animations:^{boss.frame =CGRectOffset(boss.frame, 500, 0);}
                                          completion:^(BOOL finished) {
...
-(void)deleteAnimation1
{
    ...
    [can1 setFrame:CGRectMake(95,210,92,97)];
...
-(void)deleteAnimation2
{
    ...
    [can2 setFrame:CGRectMake(194,210,92,97)];
...
-(void)deleteAnimation3
{
    ...
    [can3 setFrame:CGRectMake(285,210,92,97)];
...
-(void)deleteAnimation4
{
    ...
    [can4 setFrame:CGRectMake(382,210,92,97)];
...
-(void)deleteAnimation5
{
    ...
    [can5 setFrame:CGRectMake(478,210,92,97)];
...
-(void)deleteAnimation6
{
    ...
    [can6 setFrame:CGRectMake(569,210,92,97)];
...
- (void)animation1
{
    ...
    [UIView animateWithDuration:CUSTOMER_COME_SPEED
                     animations:^{customer1.frame =CGRectOffset(customer1.frame, 95, 0);}
                     completion:^(BOOL finished) {
                         [self deleteAnimation1];
                         [UIView animateWithDuration:CUSTOMER_GO_SPEED
                                          animations:^{customer1.frame =CGRectOffset(customer1.frame, 500, 0);}
                                          completion:^(BOOL finished) {
...
- (void)animation2
{
    ...
    [UIView animateWithDuration:CUSTOMER_COME_SPEED
                     animations:^{customer2.frame =CGRectOffset(customer2.frame, 206, 0);}
                     completion:^(BOOL finished) {
                         [self deleteAnimation2];
                         [UIView animateWithDuration:CUSTOMER_GO_SPEED
                                          animations:^{customer2.frame =CGRectOffset(customer2.frame, 500, 0);}
                                          completion:^(BOOL finished) {
...
- (void)animation3
{
    ...
    [UIView animateWithDuration:CUSTOMER_COME_SPEED
                     animations:^{customer3.frame =CGRectOffset(customer3.frame, 302, 0);}                     completion:^(BOOL finished) {
                         [self deleteAnimation3];
                         [UIView animateWithDuration:CUSTOMER_GO_SPEED
                                          animations:^{customer3.frame =CGRectOffset(customer3.frame, 500, 0);}
                                          completion:^(BOOL finished) {
...
- (void)animation4
{
    ...
    [UIView animateWithDuration:CUSTOMER_COME_SPEED
                     animations:^{customer4.frame =CGRectOffset(customer4.frame, 382, 0);}
                     completion:^(BOOL finished) {
                         [self deleteAnimation4];
                         [UIView animateWithDuration:CUSTOMER_GO_SPEED
                                          animations:^{customer4.frame =CGRectOffset(customer4.frame, 500, 0);}
                                          completion:^(BOOL finished) {
...
- (void)animation5
{
    ...
    [UIView animateWithDuration:CUSTOMER_COME_SPEED
                     animations:^{customer5.frame =CGRectOffset(customer5.frame, 467, 0);}                     completion:^(BOOL finished) {
                         [self deleteAnimation5];
                         [UIView animateWithDuration:CUSTOMER_GO_SPEED
                                          animations:^{customer5.frame =CGRectOffset(customer5.frame, 500, 0);}
                                          completion:^(BOOL finished) {
...
- (void)animation6
{
    ...
    [UIView animateWithDuration:CUSTOMER_COME_SPEED
                     animations:^{customer6.frame =CGRectOffset(customer6.frame, 569, 0);}
                     completion:^(BOOL finished) {
                         [self deleteAnimation6];
                         [UIView animateWithDuration:CUSTOMER_GO_SPEED
                                          animations:^{customer6.frame =CGRectOffset(customer6.frame, 500, 0);}
                                          completion:^(BOOL finished) {
...
-(void)gameOver
{
    ...
    scoreView=[[iPadScoreViewController alloc]initWithNibName:@"iPadScoreViewController" bundle:nil];
...
-(void)touchAnimation1
{
    ...
    UIImageView *can1 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"缶_正面_みかんジュース"]];
    [can1 setFrame:CGRectMake(178, 978, 120, 140)];
    [self.view addSubview:can1];
    
    [UIView animateWithDuration:CAN_SPEED
                     animations:^{can1.frame =CGRectOffset(can1.frame, -104,-138);}
                     completion:^(BOOL finished) {
                         [UIView animateWithDuration:CAN_SPEED
                                          animations:^{can1.frame =CGRectOffset(can1.frame, 6*temp, -45*temp);}
                                          completion:^(BOOL finished) {
                                              [self touchImage1];
...
-(void)touchAnimation2
{
    ...
    UIImageView *can2 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"缶_正面_トマトジュース"]];
    [can2 setFrame:CGRectMake(323, 978, 120, 140)];
    [self.view addSubview:can2];
    
    [UIView animateWithDuration:CAN_SPEED
                     animations:^{can2.frame =CGRectOffset(can2.frame, -172,-138);}
                     completion:^(BOOL finished) {
                         [UIView animateWithDuration:CAN_SPEED
                                          animations:^{can2.frame =CGRectOffset(can2.frame, 6*temp, -45*temp);}
                                          completion:^(BOOL finished) {
                                              [self touchImage2];
...
-(void)touchAnimation3
{
    ...
    UIImageView *can3 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"缶_正面_コンポタ"]];
    [can3 setFrame:CGRectMake(468, 978, 120, 140)];
    [self.view addSubview:can3];
    
    [UIView animateWithDuration:CAN_SPEED
                     animations:^{can3.frame =CGRectOffset(can3.frame, -199,-138);}
                     completion:^(BOOL finished) {
                         [UIView animateWithDuration:CAN_SPEED
                                          animations:^{can3.frame =CGRectOffset(can3.frame, 3*temp, -45*temp);}
                                          completion:^(BOOL finished) {
                                              [self touchImage3];
...
-(void)touchAnimation4
{
    ...
    UIImageView *can2 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"缶_正面_トマトジュース"]];
    [can2 setFrame:CGRectMake(178, 978, 120, 140)];
    [self.view addSubview:can2];
    
    [UIView animateWithDuration:CAN_SPEED
                     animations:^{can2.frame =CGRectOffset(can2.frame, -27,-138);}
                     completion:^(BOOL finished) {
                         [UIView animateWithDuration:CAN_SPEED
                                          animations:^{can2.frame =CGRectOffset(can2.frame, 6*temp, -45*temp);}
                                          completion:^(BOOL finished) {
...
-(void)touchAnimation5
{
    ...
    UIImageView *can3 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"缶_正面_コンポタ"]];
    [can3 setFrame:CGRectMake(323, 978, 120, 140)];
    [self.view addSubview:can3];
    
    [UIView animateWithDuration:CAN_SPEED
                     animations:^{can3.frame =CGRectOffset(can3.frame, -54,-138);}
                     completion:^(BOOL finished) {
                         [UIView animateWithDuration:CAN_SPEED
                                          animations:^{can3.frame =CGRectOffset(can3.frame, 3*temp, -45*temp);}
                                          completion:^(BOOL finished) {
...
-(void)touchAnimation6
{
    ...
    UIImageView *can4 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"缶_正面_コーヒー"]];
    [can4 setFrame:CGRectMake(468, 978, 120, 140)];
    [self.view addSubview:can4];
    
    [UIView animateWithDuration:CAN_SPEED
                     animations:^{can4.frame =CGRectOffset(can4.frame, -75,-138);}
                     completion:^(BOOL finished) {
                         [UIView animateWithDuration:CAN_SPEED
                                          animations:^{can4.frame =CGRectOffset(can4.frame, -3*temp, -45*temp);}
                                          completion:^(BOOL finished) {
                                              [self touchImage4];
...
-(void)touchAnimation7
{
    ...
    UIImageView *can3 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"缶_正面_コンポタ"]];
    [can3 setFrame:CGRectMake(178, 978, 120, 140)];
    [self.view addSubview:can3];
    
    [UIView animateWithDuration:CAN_SPEED
                     animations:^{can3.frame =CGRectOffset(can3.frame, 91,-138);}
                     completion:^(BOOL finished) {
                         [UIView animateWithDuration:CAN_SPEED
                                          animations:^{can3.frame =CGRectOffset(can3.frame, 3*temp, -45*temp);}
                                          completion:^(BOOL finished) {
...
-(void)touchAnimation8
{
    ...
    UIImageView *can4 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"缶_正面_コーヒー"]];
    [can4 setFrame:CGRectMake(323, 978, 120, 140)];
    [self.view addSubview:can4];
    
    [UIView animateWithDuration:CAN_SPEED
                     animations:^{can4.frame =CGRectOffset(can4.frame, 70,-138);}
                     completion:^(BOOL finished) {
                         [UIView animateWithDuration:CAN_SPEED
                                          animations:^{can4.frame =CGRectOffset(can4.frame, -3*temp, -45*temp);}
                                          completion:^(BOOL finished) {
...
-(void)touchAnimation9
{
    ...
    UIImageView *can5 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"缶_正面_コーヒーブラック"]];
    [can5 setFrame:CGRectMake(468, 978, 120, 140)];
    [self.view addSubview:can5];
    
    [UIView animateWithDuration:CAN_SPEED
                     animations:^{can5.frame =CGRectOffset(can5.frame, 54,-138);}
                     completion:^(BOOL finished) {
                         [UIView animateWithDuration:CAN_SPEED
                                          animations:^{can5.frame =CGRectOffset(can5.frame, -6*temp, -45*temp);}
                                          completion:^(BOOL finished) {
                                              [self touchImage5];
...
-(void)touchAnimation10
{
    ...
    UIImageView *can4 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"缶_正面_コーヒー"]];
    [can4 setFrame:CGRectMake(178, 978, 120, 140)];
    [self.view addSubview:can4];
    
    [UIView animateWithDuration:CAN_SPEED
                     animations:^{can4.frame =CGRectOffset(can4.frame, 215,-138);}
                     completion:^(BOOL finished) {
                         [UIView animateWithDuration:CAN_SPEED
                                          animations:^{can4.frame =CGRectOffset(can4.frame, -3*temp, -45*temp);}
                                          completion:^(BOOL finished) {
...
-(void)touchAnimation11
{
    ...
    UIImageView *can5 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"缶_正面_コーヒーブラック"]];
    [can5 setFrame:CGRectMake(323, 978, 120, 140)];
    [self.view addSubview:can5];
    
    [UIView animateWithDuration:CAN_SPEED
                     animations:^{can5.frame =CGRectOffset(can5.frame, 199,-138);}
                     completion:^(BOOL finished) {
                         [UIView animateWithDuration:CAN_SPEED
                                          animations:^{can5.frame =CGRectOffset(can5.frame, -6*temp, -45*temp);}
                                          completion:^(BOOL finished) {
...
-(void)touchAnimation12
{
    ...
    UIImageView *can6 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"缶_正面_葡萄ジュース"]];
    [can6 setFrame:CGRectMake(468, 978, 120, 140)];
    [self.view addSubview:can6];
    
    [UIView animateWithDuration:CAN_SPEED
                     animations:^{can6.frame =CGRectOffset(can6.frame, 166,-138);}
                     completion:^(BOOL finished) {
                         [UIView animateWithDuration:CAN_SPEED
                                          animations:^{can6.frame =CGRectOffset(can6.frame, -6*temp, -45*temp);}
                                          completion:^(BOOL finished) {
                                              [self touchImage6];
