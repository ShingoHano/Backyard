...
#undef INTERVAL_TIME
#endif
#define INTERVAL_TIME 0.8               //ゲーム難易度

#define MAX_LEVEL 999                   //ゲームの最大レベル
#define CUSTOMER_MAKE_X 0               //客フレーム生成時X座標

#ifdef CUSTOMER_MAKE_Y
#undef CUSTOMER_MAKE_Y
#endif
#define CUSTOMER_MAKE_Y 120              //客フレーム生成時Y座標

#ifdef CUSTOMER_SIZE_H
#undef CUSTOMER_SIZE_H
#endif
#define CUSTOMER_SIZE_H 90              //客フレーム縦サイズ

#ifdef CUSTOMER_SIZE_W
#undef CUSTOMER_SIZE_W
#endif
#define CUSTOMER_SIZE_W 90              //客フレーム横サイズ
...
@interface iPadViewController : UIViewController<UIAlertViewDelegate,UIApplicationDelegate,LeveyPopListViewDelegate>
{
    //グローバル変数の宣言
